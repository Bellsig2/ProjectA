		...
		<form action="update" method="post">
			<div class="board_wrap">
				<div class="title_area_board">
					<h2 class="board_title">수정하기</h2>
				</div>
				<div class="title_con" id="title_con_insert">
					<input type="text" placeholder="제목을 입력해주세요." name="title" value="${board.title}">
					<input type="hidden" name="num" value="${board.num}">
				</div>
				<div class="board_con">
						<textarea id="summernote" name="write_con">${board.write_con}</textarea>
				</div>
